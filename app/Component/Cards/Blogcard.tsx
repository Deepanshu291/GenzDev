...
function Blogcard({post}:{post?:blogpost}) {
  ...
  return (
    <div className="max-w-md  lg:max-w-sm  2xl:max-w-xs  border border-yellow-400 rounded-lg shadow-lg ">
      <Image className='rounded-t-lg max-h-52 ' width={"500"} height={"100"} src={post!.imgurl} alt='' />
       
      <div className="p-5">
        <Text  color={post?.colorcheame} fontWeight={'bold'}>{post?.category} </Text>
        <h6 className='text-purple-500 font-bold'> </h6>
          ...
          <p className='text-gray-800 dark:text-gray-300 font-bold my-1  text-xs'>{new Date().toLocaleDateString()}</p>
